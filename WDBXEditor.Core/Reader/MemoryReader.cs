...
namespace Acmil.Core.Reader
{
	public class MemoryReader : IDisposable
	{
		...
		public T Read<T>(IntPtr address) where T : struct
		{
			...
			{
				retVal = (T)(object)ReadCString(address);
			}
			else
			{
				...
				switch (Type.GetTypeCode(typeof(T)))
				{
					case TypeCode.Object:
						...
						Marshal.PtrToStructure(handle.AddrOfPinnedObject(), retVal);
						handle.Free();
						break;
					case TypeCode.Boolean:
						retVal = BitConverter.ToBoolean(buffer, 0);
						break;
					case TypeCode.Char:
						retVal = BitConverter.ToChar(buffer, 0);
						break;
					case TypeCode.Byte:
						retVal = buffer[0];
						break;
					...
					case TypeCode.UInt32:
						retVal = BitConverter.ToUInt32(buffer, 0);
						break;
					case TypeCode.Int64:
						retVal = BitConverter.ToInt64(buffer, 0);
						break;
					case TypeCode.UInt64:
						retVal = BitConverter.ToUInt64(buffer, 0);
						break;
					case TypeCode.Single:
						retVal = BitConverter.ToSingle(buffer, 0);
						break;
