...
{
	/// <summary>
	/// A requirement where the character must loot a particular item a certain number of times.
	/// </summary>
	public class LootItemAchievementCriteria : BaseAchievementCriteria
	{
		public override byte Type { get; internal set; } = (byte)AchievementCriteriaType.LootItem;
